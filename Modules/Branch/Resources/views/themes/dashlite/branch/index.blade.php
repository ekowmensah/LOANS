    ...
    <div class="nk-block-head-content">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">{{ trans_choice('core::general.branch',2) }}</h3>
                    <div class="nk-block-des text-soft">
                        <p>{{number_format($data->total())}} {{ trans_choice('core::general.branch',2) }} {{ trans_choice('core::general.found',1) }}</p>
                    </div>
                            ...
                            <ul class="nk-block-tools g-3">
                                ...
                                <li class="nk-block-tools-opt">
                                    @can('branch.branches.create')
                                        <a href="{{ url('branch/create') }}" class="btn btn-info btn-sm">
                        ...
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('open_date')}}">
                                    <span class="sub-text">{{ trans_choice('branch::general.open',2) }} {{ trans_choice('core::general.date',1) }}</span>
                                </a>
                            </div>
