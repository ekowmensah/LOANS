...
if (!function_exists('generate_reference')) {
    function generate_reference($setting_key = '', $id = '')
    {
        ...
        $referenceFormatSetting = Setting::where('setting_key', 'core.reference_format')->first();
        $reference_format = $referenceFormatSetting ? $referenceFormatSetting->setting_value : 'Sequence Number';
