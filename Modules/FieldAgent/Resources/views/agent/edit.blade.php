...
@section('title')
    {{ trans_choice('core::general.edit', 1) }} {{ trans_choice('fieldagent::general.field_agent', 1) }}
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('core::general.edit', 1) }} {{ trans_choice('fieldagent::general.field_agent', 1) }}</h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">{{ trans_choice('core::general.edit', 1) }} {{ trans_choice('fieldagent::general.field_agent', 1) }}</h3>
                <div class="card-tools">
                    <a href="{{ url('field-agent/agent/' . $agent->id . '/show') }}" class="btn btn-sm btn-default">
                        <i class="fas fa-arrow-left"></i> {{ trans_choice('core::general.back', 1) }}
                    </a>
                </div>
            </div>
            <form method="post" action="{{ url('field-agent/agent/' . $agent->id . '/update') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="agent_code" id="agent_code" class="form-control" value="{{ old('agent_code', $agent->agent_code) }}" required>
                                @error('agent_code')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="branch_id" id="branch_id" required>
                                    @foreach($branches as $branch)
                                        <option value="{{ $branch->id }}" {{ old('branch_id', $agent->branch_id) == $branch->id ? 'selected' : '' }}>
                                            {{ $branch->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="status" class="control-label">{{ trans_choice('core::general.status', 1) }} <span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="phone_number" id="phone_number" class="form-control" value="{{ old('phone_number', $agent->phone_number) }}">
                                @error('phone_number')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="national_id" id="national_id" class="form-control" value="{{ old('national_id', $agent->national_id) }}">
                                @error('national_id')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="commission_rate" id="commission_rate" class="form-control" value="{{ old('commission_rate', $agent->commission_rate) }}" min="0" max="100" step="0.01">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="target_amount" id="target_amount" class="form-control" value="{{ old('target_amount', $agent->target_amount) }}" min="0" step="0.01">
                                @error('target_amount')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @if($agent->photo)
                                    <div class="mb-2">
                                        <img src="{{ asset($agent->photo) }}" alt="Agent Photo" class="img-thumbnail" style="max-width: 150px;">
                                    </div>
                                @endif
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="notes" id="notes" class="form-control" rows="4">{{ old('notes', $agent->notes) }}</textarea>
                                @error('notes')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ url('field-agent/agent/' . $agent->id . '/show') }}" class="btn btn-default">
