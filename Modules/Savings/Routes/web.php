...
Route::prefix('savings')->group(function () {
    ...
    //savings files
    Route::get('{id}/file/create', 'SavingsFileController@create');
    Route::post('{id}/file/store', 'SavingsFileController@store');
    Route::get('{id}/file/show', 'SavingsFileController@show');
    Route::get('file/{id}/edit', 'SavingsFileController@edit');
    Route::post('file/{id}/update', 'SavingsFileController@update');
    Route::get('file/{id}/destroy', 'SavingsFileController@destroy');
    //charges
