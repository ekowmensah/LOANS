...
if (!function_exists('determine_period_interest_rate')) {
     ...
     * @return float
     */
    function determine_period_interest_rate($default_interest_rate, $repayment_frequency_type, $interest_rate_type, $days_in_year = 365, $days_in_month = 30, $weeks_in_year = 52, $weeks_in_month = 4)
    {
...
if (!function_exists('generate_savings_reference')) {
    function generate_savings_reference($setting_key = '', $savings = '')
    {
        ...
        $reference_format = Setting::where('setting_key', 'savings.reference_format')->first()->setting_value;
