                    ...
                    <div class="card-header p-0 border-bottom-0">
                        <ul class="nav nav-tabs">
                            ...
                            @can('savings.savings.files.index')
                                <li class="nav-item">
                                    <a href="#savings_files" class="nav-link"
                                       data-toggle="tab">
                                        {{ trans_choice('savings::general.file',2) }}
                                    </a>
                                </li>
                            @endcan
                        </ul>
                        ...
                        <div class="tab-content">
                            ...
                            @can('savings.savings.files.index')
                                <div class="tab-pane" id="savings_files">
                                    @can('savings.savings.files.create')
                                        <a href="{{url('savings/'.$savings->id.'/file/create')}}"
                                           class="btn btn-info float-right m-2">{{trans_choice('core::general.add',1)}} {{trans_choice('savings::general.file',1)}}</a>
                                    @endcan
                                    <table class="table table-striped table-bordered table-hover">
                                        <thead>
                                        <tr>
                                        ...
                                        @foreach($savings->files as $key)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{asset('storage/uploads/savings/'.$key->link)}}"
                                                       target="_blank"><i class="fas fa-download"></i> </a>
                                                    @can('savings.savings.files.edit')
                                                        <a href="{{url('savings/file/'.$key->id.'/edit')}}"><i
                                                                    class="fas fa-edit"></i> </a>
                                                    @endcan
                                                    @can('savings.savings.files.destroy')
                                                        <a href="{{url('savings/file/'.$key->id.'/destroy')}}"
