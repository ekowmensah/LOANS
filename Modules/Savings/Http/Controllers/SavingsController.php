...
//        }
        ...
        return theme_view('savings::savings.create', compact('savings_products', 'users', 'custom_fields'));
    }
    ...
    public function edit($id)
    {
        ...
        $custom_fields = CustomField::where('category', 'add_savings')->where('active', 1)->get();
        return theme_view('savings::savings.edit', compact('savings', 'users','savings_products', 'charges_list', 'custom_fields'));
    }
