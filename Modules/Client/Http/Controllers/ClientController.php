...
class ClientController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'ghana_card' => ['nullable', 'unique:clients,ghana_card'],
            'external_id' => ['nullable', 'unique:clients,external_id'],
            'dob' => ['required', 'date'],
    ...
    public function update(Request $request, $id)
    {
        $request->validate([
            ...
            'ghana_card' => ['nullable', 'unique:clients,ghana_card,' . $id],
            'external_id' => ['nullable', 'unique:clients,external_id,' . $id],
            'dob' => ['required', 'date'],
            'photo' => ['nullable', 'image', 'mimes:jpg,jpeg,png'],
        ]);
        $client = Client::find($id);
