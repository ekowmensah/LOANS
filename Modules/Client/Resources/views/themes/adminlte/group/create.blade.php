...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('core::general.add',1) }} {{ trans_choice('client::general.group',1) }}</h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content" id="app">
        <form method="post" action="{{ url('client/group/store') }}" enctype="multipart/form-data">
            {{csrf_field()}}
    ...
    <script>
        var app = new Vue({
            ...
            data: {
                ...
                meeting_frequency: "{{old('meeting_frequency', 'weekly')}}",
                meeting_day: "{{old('meeting_day')}}",
