...
@section('content')
    <section class="content" id="app">
        <div class="wizard-container">
            <form method="post" action="{{ url('client/store') }}" enctype="multipart/form-data" id="clientForm">
                {{csrf_field()}}
                
                <!-- Wizard Header -->
                <div class="wizard-header">
                    <h1><i class="fas fa-user-plus"></i> New Customer Account</h1>
                    <p>Complete all steps to create a new customer profile</p>
                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group-wizard">
                                    ...
                                    <input type="text" name="ghana_card" v-model="formData.ghana_card"
                                           ...
                                           :class="{'is-invalid': formData.ghana_card && !duplicateChecks.ghana_card.available, 'is-valid': formData.ghana_card && duplicateChecks.ghana_card.available && !duplicateChecks.ghana_card.checking}"
                                           placeholder="GHA-XXXXXXXXX-X">
                                    <span v-if="duplicateChecks.ghana_card.checking" class="text-info" style="font-size: 13px;">
                                        <i class="fas fa-spinner fa-spin"></i> Checking...
                                    </span>
                                    <span v-if="formData.ghana_card && !duplicateChecks.ghana_card.available" class="text-danger" style="font-size: 13px;">
                                        <i class="fas fa-times-circle"></i> @{{ duplicateChecks.ghana_card.message }}
                                    </span>
                                    <span v-if="formData.ghana_card && duplicateChecks.ghana_card.available && !duplicateChecks.ghana_card.checking" class="text-success" style="font-size: 13px;">
                            ...
                            <div class="col-md-6">
                                <div class="form-group-wizard">
                                    ...
                                    <input type="text" name="external_id" v-model="formData.external_id"
                                           ...
                                           :class="{'is-invalid': formData.external_id && !duplicateChecks.external_id.available, 'is-valid': formData.external_id && duplicateChecks.external_id.available && !duplicateChecks.external_id.checking}"
                                           placeholder="External reference ID">
                                    <span v-if="duplicateChecks.external_id.checking" class="text-info" style="font-size: 13px;">
                                        <i class="fas fa-spinner fa-spin"></i> Checking...
                                    </span>
                                    <span v-if="formData.external_id && !duplicateChecks.external_id.available" class="text-danger" style="font-size: 13px;">
                                        <i class="fas fa-times-circle"></i> @{{ duplicateChecks.external_id.message }}
                                    </span>
                                    <span v-if="formData.external_id && duplicateChecks.external_id.available && !duplicateChecks.external_id.checking" class="text-success" style="font-size: 13px;">
                                        <i class="fas fa-check-circle"></i> Available
                                    </span>
                                    @error('external_id')
                                    <span class="text-danger" style="font-size: 13px;">
