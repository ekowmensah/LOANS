...
//client relationship
        ...
        Route::prefix('group')->group(function () {
            ...
            Route::post('/', 'Api\v1\GroupController@store');
            Route::get('{id}', 'Api\v1\GroupController@show');
            Route::put('{id}', 'Api\v1\GroupController@update');
            Route::delete('{id}', 'Api\v1\GroupController@destroy');
            
            // Member management
            Route::post('{id}/members', 'Api\v1\GroupController@addMember');
            Route::delete('{id}/members/{memberId}', 'Api\v1\GroupController@removeMember');
            Route::put('{id}/members/{memberId}', 'Api\v1\GroupController@updateMember');
            Route::get('{id}/members', 'Api\v1\GroupController@getMembers');
            Route::get('{id}/loans', 'Api\v1\GroupController@getLoans');
        });
