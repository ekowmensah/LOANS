    ...
    <script>
        var app = new Vue({
            ...
            data: {
                ...
                schedule: "{{old('schedule',$loan_charge->schedule ?? 0)}}",
                schedule_frequency: "{{old('schedule_frequency',$loan_charge->schedule_frequency ?? '')}}",
                schedule_frequency_type: "{{old('schedule_frequency_type',$loan_charge->schedule_frequency_type ?? 'days')}}",
