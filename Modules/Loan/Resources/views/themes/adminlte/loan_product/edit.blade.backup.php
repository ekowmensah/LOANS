                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="loan_term_type"
                                       class="control-label">{{trans_choice('loan::general.loan',1)}} {{trans_choice('loan::general.term',1)}} {{trans_choice('core::general.type',1)}}</label>
                                <select class="form-control @error('loan_term_type') is-invalid @enderror"
                                        name="loan_term_type" v-model="loan_term_type" id="loan_term_type" required>
