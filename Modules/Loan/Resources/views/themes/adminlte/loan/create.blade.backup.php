        ...
        var app = new Vue({
            ...
            computed: {
                ...
                totalInterest() {
                    ...
                    // Convert term to months based on repayment_frequency_type
                    let termInMonths = term;
                    if (this.repayment_frequency_type === 'days') {
                        termInMonths = term / 30; // Convert days to months
                    } else if (this.repayment_frequency_type === 'weeks') {
                        termInMonths = term / 4.33; // Convert weeks to months (52 weeks / 12 months)
                    }
                ...
                numberOfInstallments() {
                    ...
                    // If loan term is 12 months and repayment frequency is 1 month, then 12 installments
                    // If loan term is 12 months and repayment frequency is 2 months, then 6 installments
                    ...
                    if (this.loan_product_id != "") {
                        this.loan_products.forEach(item => {
                            if (item.id == this.loan_product_id) {
                                ...
                                // Validate applied amount against product limits
