            ...
            <div class="card-header">
                ...
                <div class="btn-group">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-xs">
                            ...
                            <a href="{{request()->fullUrlWithQuery(['status'=>'submitted'])}}"
                               class="dropdown-item {{request('status')=='submitted'?'active':''}}">
                                Submitted
                            </a>
                            <a href="{{request()->fullUrlWithQuery(['status'=>'approved'])}}"
                               class="dropdown-item {{request('status')=='approved'?'active':''}}">
                                Approved
                            </a>
                            ...
                            <a href="{{request()->fullUrlWithQuery(['status'=>'closed'])}}"
                               class="dropdown-item {{request('status')=='closed'?'active':''}}">
                                Closed
                            </a>
                            ...
                            <a href="{{request()->fullUrlWithQuery(['status'=>'written_off'])}}"
                               class="dropdown-item {{request('status')=='written_off'?'active':''}}">
                                Written Off
                            </a>
                        </div>
                    </div>
                ...
                <div class="btn-group">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-xs">
                            <a href="{{request()->fullUrlWithQuery(['loan_provisioning_id'=>''])}}"
                               class="dropdown-item {{request('loan_provisioning_id')==''?'active':''}}">
                                All
                            </a>
                            @foreach($loan_provisioning as $item)
                                <a href="{{request()->fullUrlWithQuery(['loan_provisioning_id'=>$item->id])}}"
                                   class="dropdown-item {{request('loan_provisioning_id')==$item->id?'active':''}}">
                                    {{$item->name}}
                                </a>
                            @endforeach
                        </div>
