...
class LoanProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'repayment_frequency' => ['nullable', 'numeric'],
            'repayment_frequency_type' => ['nullable'],
        ...
        $loan_product->deduct_interest_from_principal = $request->deduct_interest_from_principal?1:0;
        $loan_product->disallow_interest_rate_adjustment = $request->disallow_interest_rate_adjustment?1:0;
        $loan_product->exclude_weekends = $request->exclude_weekends;
        $loan_product->exclude_holidays = $request->exclude_holidays;
