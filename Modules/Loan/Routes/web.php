...
Route::prefix('loan')->group(function () {
    ...
    Route::get('search_client', 'LoanController@search_client');
    ...
    Route::get('{id}/member-allocations', 'LoanController@member_allocations');
    Route::get('{id}/member-allocations/{allocation_id}', 'LoanController@member_allocation_detail');
    Route::get('{id}/member-allocations/{allocation_id}/payment/create', 'LoanController@create_member_payment');
    Route::post('{id}/member-allocations/{allocation_id}/payment/store', 'LoanController@store_member_payment');
...
//applications
    ...
    //schedules
    Route::get('{id}/schedule/show', 'LoanScheduleController@show_schedule');
    Route::get('{id}/schedule/pdf', 'LoanScheduleController@pdf_schedule');
    Route::get('{id}/schedule/print', 'LoanScheduleController@print_schedule');
    Route::get('{id}/schedule/edit', 'LoanScheduleController@edit');
    Route::post('{id}/schedule/update', 'LoanScheduleController@update');
    //repayments
    ...
    //repayments
    Route::prefix('repayment')->group(function () {
        Route::get('/', 'LoanRepaymentController@index');
        Route::get('get_repayments', 'LoanRepaymentController@get_funds');
        Route::get('create', 'LoanRepaymentController@create');
        Route::post('store', 'LoanRepaymentController@store');
        Route::get('bulk/create', 'LoanRepaymentController@bulk_create');
        Route::post('bulk/store', 'LoanRepaymentController@bulk_store');
        Route::get('{repayment}/show', 'LoanRepaymentController@show');
        Route::get('{repayment}/edit', 'LoanRepaymentController@edit');
        Route::post('{repayment}/update', 'LoanRepaymentController@update');
        Route::get('{repayment}/destroy', 'LoanRepaymentController@destroy');
    });
    //purposes
    ...
    //loan provisioning
    Route::prefix('loan_provisioning')->group(function () {
        Route::get('/', 'LoanProvisioningController@index');
        Route::get('get_products', 'LoanProvisioningController@get_products');
        Route::get('create', 'LoanProvisioningController@create');
        Route::post('store', 'LoanProvisioningController@store');
        Route::get('{provisioning}/show', 'LoanProvisioningController@show');
        Route::get('{provisioning}/edit', 'LoanProvisioningController@edit');
        Route::post('{provisioning}/update', 'LoanProvisioningController@update');
        Route::get('{provisioning}/destroy', 'LoanProvisioningController@destroy');
    });
